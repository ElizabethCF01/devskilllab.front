        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <div v-if="auth.user" class="flex items-center gap-4 relative">
            <button @click="() => showDrop = !showDrop">
              <img class="w-10 h-10 rounded-full" :src="`https://api.multiavatar.com/${auth.user.email}.png`" alt="">
            </button>
            ...
            <!-- Dropdown menu -->
            <div
              :class="`z-10 divide-y divide-gray-100 rounded-lg shadow w-44 bg-zinc-800  absolute top-14 left-0 ${!showDrop ? 'hidden' : ''}`">
          ...
          <ul
            ...
            <li>
              <router-link to="/challenges"
                class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-primary md:p-0 ">Challenges</router-link>
            </li>
            <li>
              <router-link to="/code"
                class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:hover:text-primary md:p-0 "
                aria-current="page">Playground</router-link>
            </li>
            <li>
              <a href="#"
                class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-primary md:p-0 ">Contact</a>
            </li>
          </ul>
        </div>
      </div>
